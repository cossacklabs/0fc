    ...
    while True:
        ...
        if message.tp == web.MsgType.text:
            ...
            if message_params[0] == COMMAND.NEW_ROOM and pub_key:
                ...
                ws_response.send_str('{} {}'.format(COMMAND.NEW_ROOM,
                                                    new_room_id))
                ...
                if (message_params[1] in online and
                ...
                ws_response.send_str(
                        '{} malformed request'.format(COMMAND.ERROR))
...
def index(request):
    ...
    return {'url': url,
            'server_public_key': 'VUVDMgAAAC2IRalnA7mIDaKlK5HvBz2woET8cc2dJQ3sOQMYQ/13TtUNofnQ',
